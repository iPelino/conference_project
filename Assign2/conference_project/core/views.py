...
def testing_stuff(request, number):
    ...
    speakers = [ 
        { 'id':1,'name':"eric","bio":"software developer",'email':"eric@mail.com" }, 
        {'id':2,'name':"eric","bio":"software developer",'email':"eric@mail.com"}, 
        { 'id':3,'name':"david","bio":"software developer",'email':"eric@mail.com" }, 
        { 'id':4,'name':"papa messi","bio":"software developer",'email':"eric@mail.com" }, 
        { 'id':5,'name':"samuel","bio":"software developer",'email':"eric@mail.com" }, 
        ] 
        def home(request): 
